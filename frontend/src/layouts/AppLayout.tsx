...
const navItems = [
  ...
  { label: "Startup Incubator", to: "/startup-incubator", icon: Rocket, subtitle: "Validate ideas, build MVPs, and prepare pitches" },
  ...
  { label: "Portfolio Generator", to: "/portfolio-generator", icon: Layers3, subtitle: "AI-generated portfolio and recruiter showcase" },
  { label: "Research Hub", to: "/research-hub", icon: Microscope, subtitle: "Research collaborators, mentors, projects, and publication tracking" },
